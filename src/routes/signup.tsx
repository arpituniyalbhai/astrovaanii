  ...
  head: () => ({
    meta: [
      { title: "Create your account — AstroVaanii" },
      {
        name: "description",
        content:
          "Sign up in three quick steps and start chatting with Vaanii, your personal AI astrologer.",
      },
          ...
          <div className="hidden md:block">
            ...
            <ul className="mt-8 space-y-4 text-sm">
              {[
                [
                  "Private by default",
                  "End-to-end encrypted birth data. Never sold, never shared.",
                ],
        ...
        >
          <div className="relative bg-gradient-to-br from-[color:var(--gold)]/25 via-card to-[color:var(--clay)]/20 px-6 pt-7 pb-5">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div id="vaanii-intro-title" className="font-display text-xl">
                  A quick hello 🙏
                </div>
          ...
          <div className="space-y-3 px-6 py-5 text-sm leading-relaxed">
            <p className="rounded-2xl rounded-tl-sm bg-background/70 px-4 py-3 text-foreground">
              Hey, I'm <span className="font-medium text-primary">Vaanii AI</span> — your personal
              AI astrologer.
            </p>
            <p className="rounded-2xl rounded-tl-sm bg-background/70 px-4 py-3 text-foreground">
              You're just <span className="font-medium">three quick steps</span> away from starting
              your journey with me.
            </p>
            <p className="rounded-2xl rounded-tl-sm bg-background/70 px-4 py-3 text-foreground">
              I'm here to make every interaction feel personal and meaningful from the very
              beginning.
            </p>
            <p className="rounded-2xl rounded-tl-sm bg-background/70 px-4 py-3 text-foreground">
              Create your account to continue — your information stays private, secure and protected
              with us.
            </p>
